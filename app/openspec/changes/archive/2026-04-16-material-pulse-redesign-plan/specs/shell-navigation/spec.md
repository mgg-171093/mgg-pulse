...
(Previously: The shell only required a left-side panel with Dashboard, Settings, and About and did not forbid duplicate settings entries or define localized labeling.)
