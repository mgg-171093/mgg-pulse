...
[![Version](https://img.shields.io/badge/Version-1.3.2-blue?style=flat-square)](./app/build/latest.json)
...
1. Download `MGGPulse-Setup-1.3.2.exe` from [Releases](https://github.com/mgg-171093/mgg-pulse/releases)
...
# Override version
pwsh -File build/build.ps1 -Version 1.3.2
